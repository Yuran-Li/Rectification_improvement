...
def main():
    ...
    ap.add_argument("--train_verify", default=str(REPO / "datasets/sft/sft_verify_train.jsonl"))
    ap.add_argument("--train_rectify", default=str(REPO / "datasets/sft/sft_rectify_train.jsonl"))
